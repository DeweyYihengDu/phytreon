...
- **infer** — NJ/UPGMA (model-corrected distances), native ML for nucleotide
  ...
  Camin-Sokal for single-cell lineage tracing from CRISPR scars or somatic
  mutations), expression-similarity dendrograms (`expression_dendrogram` --
  not phylogenetic), bootstrap, built-in MSA, trimming
